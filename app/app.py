...
import uuid
import tempfile
from app.user import auth_backend, current_active_user, fastapi_users, get_custom_auth_router
...
app.include_router(get_custom_auth_router(auth_backend), prefix="/auth/jwt", tags=["auth"])
